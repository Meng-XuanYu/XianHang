...
public class HistoryActivity extends AppCompatActivity {
    ...
    private List<GetHistoryResponse.Commodity> commodities;
...
//        );
    ...
    private void getHistory() {
        ...
        // 发送 POST 请求
        apiService.getHistory(userId).enqueue(new Callback<GetHistoryResponse>() {
            @Override
            public void onResponse(Call<GetHistoryResponse> call, Response<GetHistoryResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if ("success".equals(getHistoryResponse.getStatus())) {
                        ...
                        Log.e("History", "Error: " + getHistoryResponse.getMessage());
                    }
                } else {
                    try {
                        // 从 errorBody 获取错误信息
                        ...
                        Log.e("History", "Error: " + errorMessage);
                    } catch (Exception e) {
                        Toast.makeText(HistoryActivity.this, "解析错误消息失败", Toast.LENGTH_SHORT).show();
                        Log.e("History", "Error parsing error body: ", e);
                    }
                }
            }
            ...
            public void onFailure(Call<GetHistoryResponse> call, Throwable t) {
                ...
                Log.e("History", "Request Failed: " + t.getMessage());
            }
        });
    }
